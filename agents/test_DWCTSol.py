...
@evals.agent(FoundryAgentConfig(agent_name="DWCTSol", project_endpoint=PROJECT_ENDPOINT)) # Links this test class to the Foundry agent
class Test_DWCTSol:
    """
    Test class for the Agent: DWCTSol.
