# Agent Evaluation Project: DWCTSol
...
2. Click the ▶️ button next to `test_DWCTSol.py` to run all tests
...
```
DWCTSol-eval/
├── test_DWCTSol.py    # Main evaluation test file
...
2. **Discover Tests**: VS Code automatically discovers tests in `test_DWCTSol.py`
...
# Run a specific test
pytest test_DWCTSol.py::Test_DWCTSol::test_coherence
...
1. Open `test_DWCTSol.py` in VS Code
