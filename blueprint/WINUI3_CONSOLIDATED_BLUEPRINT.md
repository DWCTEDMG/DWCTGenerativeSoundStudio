...
| Workflow fixture and review-contract tests | Committed in `e4426ea`; focused renderer/workflow suite passes 63 tests | Preserve the explicit media fixture and reviewed-before-apply contract; broader release and native UI gates remain separate. |
