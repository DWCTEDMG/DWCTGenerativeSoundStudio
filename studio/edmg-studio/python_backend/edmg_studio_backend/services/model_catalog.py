...
def built_in_catalog() -> list[dict[str, Any]]:
    ...
    return [
        _entry(
            ...
            notes="Lighter local director fallback for CPU-only or low-memory systems.",
        ...
        _entry(
            ...
            recommended="default",
            notes="Higher quality local director model. Best default for offline planning on capable systems.",
    ...
    return [
        {
            ...
            "description": "Installs the default Qwen2.5 7B Ollama director model. Use this if you only want planning, ingest, and preflight right now.",
            "models": ["ollama_qwen2p5_7b_instruct"],
        },
        {
            "id": "creator",
            "name": "Creator (Recommended)",
            "description": "Installs the default Qwen2.5 7B Ollama director model plus SDXL Base for broadly compatible ComfyUI still rendering.",
            "models": ["ollama_qwen2p5_7b_instruct", "hf_sdxl_base_1_0"],
        },
        {
            "id": "stability_sd35",
