...
def built_in_catalog() -> list[dict[str, Any]]:
    ...
    entries = [
        ...
        _entry(
            model_id="hf_qwen3_vl_30b_director",
            name="Qwen3-VL-30B-A3B Instruct (Internal Director)",
            kind="transformers",
            source="hf",
            ...
            recommended="advanced",
            notes="High-tier Director discovery entry. Installation remains disabled until a pinned revision, memory profile, and local qualification are recorded.",
            family="qwen3_vl",
            tags=["internal", "director", "planning", "vision", "high-tier", "unverified"],
            hardware_targets=["nvidia"],
        ),
        _entry(
            model_id="hf_hunyuan_video15_internal",
            name="HunyuanVideo-1.5 (Internal Renderer)",
            kind="video_diffusers",
            source="hf",
            hf_repo_id="tencent/HunyuanVideo-1.5",
            hf_revision="9b49404b3f5df2a8f0b31df27a0c7ab872e7b038",
            ...
            render={
                ...
                "workflow_family": "hunyuan_video15",
                "render_modes": [],
                "video_model_engine": "hunyuan_video15",
                "preferred_for": ["fast", "low_vram", "automatic"],
            },
        ),
        _entry(
            ...
            render={
                "engine": "internal_video_model",
                "workflow_family": "ltx_25",
                "render_modes": [],
                "video_model_engine": "ltx_25",
                "preferred_for": ["quality", "maximum"],
            },
        ),
        _entry(
