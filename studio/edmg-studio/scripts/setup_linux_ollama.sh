...
OLLAMA_MODELS="${OLLAMA_MODELS:-${EDMG_STUDIO_HOME}/models/ollama}"
OLLAMA_LOG_DIR="${OLLAMA_LOG_DIR:-${EDMG_STUDIO_HOME}/logs}"
...
mkdir -p "${OLLAMA_MODELS}" "${OLLAMA_LOG_DIR}" "${EDMG_STUDIO_HOME}/data" "${EDMG_STUDIO_HOME}/cache" "${EDMG_STUDIO_HOME}/external"
