...
For the current WinUI-only Windows status, capability boundaries, phase evidence, and release
gates, see the [WinUI 3 consolidated blueprint](../blueprint/WINUI3_CONSOLIDATED_BLUEPRINT.md).
The Linux AppImage and Electron sections are compatibility procedures and do not define the Windows
release candidate.
