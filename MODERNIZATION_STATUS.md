...
| P0-06 | In progress | P0-05, W1-01 | `scripts/benchmark_day1_baseline.py`; benchmark tests; `docs/BENCHMARKING.md`; machine-readable results | Focused benchmark tests, named-hardware measurement, Electron smoke, and Python scope timing | Runner implemented; commit it, then record evidence from the clean commit before marking complete |
